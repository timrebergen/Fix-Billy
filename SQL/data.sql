-- DROP SCHEMA sch_kennis;
--drop schema sch_kennis;

-- CREATE SCHEMA sch_kennis;
--CREATE SCHEMA sch_kennis;

-- sch_kennis.kenniskaart definition
-- Drop table
...
-- Comments
    ...
    comment on column sch_kennis.kenniskaart.competentie
    ...
    comment on column sch_kennis.kenniskaart.why
        is 'waarom de kenniskaart is gemaakt';
    comment on column sch_kennis.kenniskaart.how
    ...
    comment on column sch_kennis.kenniskaart.studieduur
        is 'hoelang het duur om de kenniskaart te bestuderen';
    comment on column sch_kennis.kenniskaart.rating
        is 'wat voor rating de kenniskaart is gegeven';

-- Data insert into
INSERT INTO sch_kennis.kenniskaart (onderwerp,rol,competentie,wat,why,how,plaatje,bronnen,niveau,studieduur,rating) VALUES
